<div class="grid lg:grid-cols-3 md:grid-cols-2 gap-5">
	...
	>
		<div class="flex-1 flex flex-col p-8 items-center">
			...
			<h3 class="mt-6 text-gray-900 text-lg font-medium">Upin & Ipin</h3>
			<dl class="mt-1 flex-grow flex flex-col justify-between">
				<dt class="sr-only">Title</dt>
				<dd class="text-gray-500 text-md">08123456789</dd>
				...
				<div class="-ml-px w-0 flex-1 flex">
					...
					>
						...
						>
							...
							/>
						</svg><span class="ml-1">Setup</span>
					</a>
				</div>
			</div>
		</div>
	...
	>
		<div class="flex-1 flex flex-col p-8 items-center">
			...
			<h3 class="mt-6 text-gray-900 text-lg font-medium">Jarjit Singh</h3>
			<dl class="mt-1 flex-grow flex flex-col justify-between">
				<dt class="sr-only">Title</dt>
				<dd class="text-gray-500 text-md">08123456789</dd>
				<dt class="sr-only">Role</dt>
				<dd class="mt-3">
					<span class="px-2 py-1 text-green-900 text-xs font-medium bg-yellow-200 rounded-full"
						>Waiting data...</span
					>
				</dd>
			</dl>
	...
	>
		<div class="flex-1 flex flex-col p-8 items-center">
			...
			<h3 class="mt-6 text-gray-900 text-lg font-medium">Kak Roes</h3>
			<dl class="mt-1 flex-grow flex flex-col justify-between">
				<dt class="sr-only">Title</dt>
				<dd class="text-gray-500 text-md">08123456789</dd>
				<dt class="sr-only">Role</dt>
				<dd class="mt-3">
					<span class="px-2 py-1 text-green-900 text-xs font-medium bg-red-100 rounded-full"
						>Close</span
					>
				</dd>
			</dl>
	...
	>
		<div class="flex-1 flex flex-col p-8 items-center">
			...
			<h3 class="mt-6 text-gray-900 text-lg font-medium">Tok Dalang</h3>
			<dl class="mt-1 flex-grow flex flex-col justify-between">
				<dt class="sr-only">Title</dt>
				<dd class="text-gray-500 text-md">08123456789</dd>
				<dt class="sr-only">Role</dt>
				<dd class="mt-3">
					<span class="px-2 py-1 text-red-800 text-xs font-medium bg-red-200 rounded-full"> Not Connected </span
					>
				</dd>
			</dl>
		</div>
