<div class="grid lg:grid-cols-3 md:grid-cols-2 gap-6 mt-6">
	...
	>
		<div class="flex-1 flex flex-col p-8 items-center">
			...
			<h3 class="mt-6 text-gray-900 text-lg font-medium">Mail</h3>
				...
				<div class="w-0 flex-1 flex">
					...
					>
						...
						>
							...
							/>
						</svg><span class="ml-3">Login</span>
					</a>
				</div>
				<div class="-ml-px w-0 flex-1 flex">
					...
					>
						...
						>
							...
							/>
						</svg><span class="ml-3">Setup</span>
					</a>
				</div>
			</div>
		</div>
	...
	>
		<div class="flex-1 flex flex-col p-8 items-center">
			...
			<h3 class="mt-6 text-gray-900 text-lg font-medium">Fizi</h3>
			<dl class="mt-1 flex-grow flex flex-col justify-between">
				<dt class="sr-only">Title</dt>
				<dd class="text-gray-500 text-md">08123456789</dd>
				<dt class="sr-only">Role</dt>
